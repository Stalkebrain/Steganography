...
public class ImageHistogram {
    public static void main(String[] args) {
        try {
            ...
            BufferedImage image = ImageIO.read(new File("E:\\Users\\Stalkerbrain\\Диплом\\Проги\\untitled\\джоджо\\jojo_stego.bmp")); // Укажите путь к изображению
            ...
            try (FileWriter writer = new FileWriter("E:\\Users\\Stalkerbrain\\Диплом\\Проги\\untitled\\histogram_data.txt")) {
