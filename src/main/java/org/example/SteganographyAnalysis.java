...
public class SteganographyAnalysis {
    public static void main(String[] args) {
        ...
        String filePath = "E:\\Users\\Stalkerbrain\\Диплом\\Проги\\untitled\\histogram_data.txt";
        ...
        try {
            ...
            // Вычисление χ²
            for (int j = 0; j < 128; j++) {
                double n2j = frequencyMap.getOrDefault(2 * j, 0);
                double nj = frequencyMap.getOrDefault(j, 0);
